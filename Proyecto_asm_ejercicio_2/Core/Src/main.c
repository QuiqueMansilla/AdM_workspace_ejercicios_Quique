...
#include "string.h"
#include "asm_func.h"
#include "asm_propducto_escalar32.h"
...
int main(void)
{
  ...
  uint32_t factor = 2; //Valor de la variable "escalar"

  // Ejecutar por cada función:
  DWT->CYCCNT = 0;
  productoEscalar32(vec_in, vec_out, lon, factor);
  ...
  // Ejecutar por cada función:
  DWT->CYCCNT = 0;
  asm_producto_escalar32(vec_in, vec_out, lon, factor1);
